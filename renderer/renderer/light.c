...
uint32_t blinn_phong_shading(vect3_t normal, vect3_t light_direction, vect3_t view_direction,
	...
	//Diffuse component
	float diffuse_intensity_factor = fmax(-vect3_dot(normal, light_direction), 0.0);
	...
	vect3_t halfway_direction = vect3_add(view_direction, vect3_mul(light_direction, -1.0)); //inverse the light direction
